...
copy2_node = blas.level1.copy.Copy(
    "COPY2",
    dtype=DATATYPE,
    n = n*n
)
copy2_node.implementation = ('cublas' if IMPLEM == 'cublas' else 'simple')

copy3_node = blas.level1.copy.Copy(
    "COPY3",
    dtype=DATATYPE,
    n = n*n
)
copy3_node.implementation = ('cublas' if IMPLEM == 'cublas' else 'simple')

copy4_node = blas.level1.copy.Copy(
    "COPY4",
    dtype=DATATYPE,
    n = n*n
)
copy4_node.implementation = ('cublas' if IMPLEM == 'cublas' else 'simple')

copy5_node = blas.level1.copy.Copy(
    "COPY5",
    dtype=DATATYPE,
    n = n*n
)
copy5_node.implementation = ('cublas' if IMPLEM == 'cublas' else 'simple')

copy6_node = blas.level1.copy.Copy(
    "COPY6",
    dtype=DATATYPE,
    n = n*n
)
copy6_node.implementation = ('cublas' if IMPLEM == 'cublas' else 'simple')

copy7_node = blas.level1.copy.Copy(
    "COPY7",
    dtype=DATATYPE,
    n = n*n
)
copy7_node.implementation = ('cublas' if IMPLEM == 'cublas' else 'simple')

copy8_node = blas.level1.copy.Copy(
    "COPY8",
    dtype=DATATYPE,
    n = n*n
)
copy8_node.implementation = ('cublas' if IMPLEM == 'cublas' else 'simple')
...
ger1_node.implementation = IMPLEM
...
ger2_node.implementation = IMPLEM
...
ger3_node.implementation = IMPLEM
...
ger4_node.implementation = IMPLEM
...
ger5_node.implementation = IMPLEM
...
ger6_node.implementation = IMPLEM
...
ger7_node.implementation = IMPLEM
...
ger8_node.implementation = IMPLEM
...
A1 = test_state.add_access("A_ger")

A2 = test_state.add_access("A2")
A2_res = test_state.add_access("A2")

A3 = test_state.add_access("A3")
A3_res = test_state.add_access("A3")

A4 = test_state.add_access("A4")
A4_res = test_state.add_access("A4")

A5 = test_state.add_access("A5")
A5_res = test_state.add_access("A5")

A6 = test_state.add_access("A6")
A6_res = test_state.add_access("A6")

A7 = test_state.add_access("A7")
A7_res = test_state.add_access("A7")

A8 = test_state.add_access("A8")
A8_res = test_state.add_access("A8")
...
test_state.add_memlet_path(
    A_in, copy2_node,
    dst_conn="_x",
    memlet=Memlet.simple(A_in.data, "0:n*n")
)

test_state.add_memlet_path(
    copy2_node, A2,
    src_conn="_res",
    memlet=Memlet.simple(A2.data, "0:n*n")
)
...
test_state.add_memlet_path(
    copy3_node, A3,
    src_conn="_res",
    memlet=Memlet.simple(A3.data, "0:n*n")
)
...
test_state.add_memlet_path(
    copy4_node, A4,
    src_conn="_res",
    memlet=Memlet.simple(A4.data, "0:n*n")
)
...
test_state.add_memlet_path(
    copy5_node, A5,
    src_conn="_res",
    memlet=Memlet.simple(A5.data, "0:n*n")
)
...
test_state.add_memlet_path(
    copy6_node, A6,
    src_conn="_res",
    memlet=Memlet.simple(A6.data, "0:n*n")
)
...
test_state.add_memlet_path(
    copy7_node, A7,
    src_conn="_res",
    memlet=Memlet.simple(A7.data, "0:n*n")
)
...
test_state.add_memlet_path(
    copy8_node, A8,
    src_conn="_res",
    memlet=Memlet.simple(A8.data, "0:n*n")
)
...
test_state.add_memlet_path(
    ger2_node, A2_res,
    src_conn="_RES",
    memlet=Memlet.simple(A2_res.data, "0:n*n", veclen=VECWIDTH)
)

test_state.add_memlet_path(
    ger3_node, A3_res,
    src_conn="_RES",
    memlet=Memlet.simple(A3_res.data, "0:n*n", veclen=VECWIDTH)
)

test_state.add_memlet_path(
    ger4_node, A4_res,
    src_conn="_RES",
    memlet=Memlet.simple(A4_res.data, "0:n*n", veclen=VECWIDTH)
)

test_state.add_memlet_path(
    ger5_node, A5_res,
    src_conn="_RES",
    memlet=Memlet.simple(A5_res.data, "0:n*n", veclen=VECWIDTH)
)

test_state.add_memlet_path(
    ger6_node, A6_res,
    src_conn="_RES",
    memlet=Memlet.simple(A6_res.data, "0:n*n", veclen=VECWIDTH)
)

test_state.add_memlet_path(
    ger7_node, A7_res,
    src_conn="_RES",
    memlet=Memlet.simple(A7_res.data, "0:n*n", veclen=VECWIDTH)
)

test_state.add_memlet_path(
    ger8_node, A8_res,
    src_conn="_RES",
    memlet=Memlet.simple(A8_res.data, "0:n*n", veclen=VECWIDTH)
)
...
gemv1_node.implementation = IMPLEM
...
gemv2_node.implementation = IMPLEM
...
gemv3_node.implementation = IMPLEM
...
gemv4_node.implementation = IMPLEM
...
gemv5_node.implementation = IMPLEM
...
gemv6_node.implementation = IMPLEM
...
gemv7_node.implementation = IMPLEM
...
gemv8_node.implementation = IMPLEM
...
asum_node.implementation = IMPLEM


buf1 = test_state.add_access("vec2")
buf2 = test_state.add_access("vec4")
buf3 = test_state.add_access("vec6")
buf4 = test_state.add_access("vec8")
buf5 = test_state.add_access("vec4")
buf6 = test_state.add_access("vec8")
buf7 = test_state.add_access("vec8")
...
print("\n----- COMPILE & RUN (FPGA) -----")
print("Running implementation: ", IMPLEM)
start = time.time()
